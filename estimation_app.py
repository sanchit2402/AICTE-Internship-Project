...
# Footer with name credit and AICTE Internship mention
st.markdown("<hr>", unsafe_allow_html=True)
st.markdown("Made with ❤️ by **Sanchit Jain** | During **AICTE Internship**", unsafe_allow_html=True)
